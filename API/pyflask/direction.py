...
def main(file_path):
    ...
    left_filepath = os.path.join("pyflask/static/recording/", filename + "_left.wav")
    right_filepath = os.path.join("pyflask/static/recording/", str(filename) + "_right.wav")
    left_channel.export(left_filepath, format="wav")
    right_channel.export(right_filepath, format="wav")

    signal1, sr1 = librosa.load(os.path.join("pyflask/static/recording/", filename + "_left.wav"), sr=None)

    signal2, sr2 = librosa.load(os.path.join("pyflask/static/recording/", filename + "_right.wav"), sr=None)
